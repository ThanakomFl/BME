...
function db_get_record($table, $conditions)
{
    ...
    return db_get_record_sql($sql, $conditions);
}
 ...
 * @return bool|stdClass[]
 */
function db_get_records_array($table, $conditions = array(), $sort = '', $sort_type = SORT_ASC)
{
    ...
    return db_get_records_sql($sql, $conditions);
}
